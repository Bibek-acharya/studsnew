      ...
      <div className="max-w-125 w-full bg-white rounded-2xl border border-gray-200 p-6 sm:p-10 shadow-sm relative overflow-hidden">
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <label className="relative cursor-pointer">
              ...
              />
              <div className="w-24 h-14 border-2 border-gray-200 rounded-md flex items-center justify-center hover:border-gray-300 transition-colors peer-checked:border-brand-blue overflow-hidden p-1">
                <Image
                  src="/esewa_logo.jpg"
                  alt="eSewa"
                  width={80}
              ...
              <div className="absolute -top-2 -right-2 bg-brand-blue text-white rounded-full w-5 h-5 flex items-center justify-center opacity-0 peer-checked:opacity-100 transition-opacity shadow-sm">
            ...
            {(applicationData?.paymentConfig?.methods && applicationData?.paymentConfig?.methods.includes("bank")) && (
              <label className="relative cursor-pointer">
                <input
                  ...
                  className="peer sr-only"
                />
                <div className="w-24 h-14 border-2 border-gray-200 rounded-md flex flex-col items-center justify-center hover:border-gray-300 transition-colors peer-checked:border-brand-blue peer-checked:bg-blue-50/50">
                  <Landmark className="w-5 h-5 text-gray-500 peer-checked:text-brand-blue mb-0.5 transition-colors" />
                  <span className="text-[10px] font-bold text-gray-500 peer-checked:text-brand-blue transition-colors">Bank QR</span>
                </div>
                <div className="absolute -top-2 -right-2 bg-brand-blue text-white rounded-full w-5 h-5 flex items-center justify-center opacity-0 peer-checked:opacity-100 transition-opacity shadow-sm">
                  <CheckCircle className="w-3 h-3" />
                </div>
          ...
          <div className="bg-blue-50/30 border border-blue-100 rounded-xl p-4">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1 text-[13px] space-y-1.5 pt-1">
                ...
                <p className="flex justify-between">
                  ...
                  <span className="font-bold text-brand-blue">{applicationData?.paymentConfig?.bank_details?.account_number || "01234567890123"}</span>
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-brand-blue file:text-white hover:file:bg-[#004d00] cursor-pointer border border-gray-200 rounded-md bg-white transition-colors"
              />
              {paymentScreenshot && (
        ...
        <div className="w-full bg-gray-50 border border-gray-200 rounded-xl p-5 mb-6 shadow-sm">
          ...
          <div className="border-t border-gray-200 pt-3 flex justify-between items-center">
            ...
            <span className="font-bold text-xl text-brand-blue">Rs. {feeAmount}.00</span>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border-2 border-gray-200 rounded-md pl-10 pr-4 py-3 text-sm focus:border-brand-blue outline-none transition-colors"
            ...
            <div className="flex-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border-2 border-gray-200 rounded-md pl-10 pr-4 py-3 text-sm tracking-wide focus:border-brand-blue outline-none transition-colors"
        ...
        {!showBankPanel && (
          <div className="space-y-4 mb-8">
            <div className="flex items-start text-[13px] text-gray-500 bg-blue-50/40 p-3.5 rounded-xl border border-blue-100">
              <Info className="w-4 h-4 text-brand-blue mt-0.5 mr-2.5 shrink-0" />
            ...
            <label className="flex items-center space-x-3 cursor-pointer pt-1">
              <input type="checkbox" className="w-4 h-4 text-brand-blue rounded border-gray-300 focus:ring-brand-blue" defaultChecked />
        ...
        <button
          ...
          className="w-full bg-brand-blue hover:bg-[#004d00] disabled:bg-gray-400 text-white font-bold py-4 px-6 rounded-xl transition duration-200 flex items-center justify-center gap-2 disabled:cursor-not-allowed"
        >
          {isProcessing ? (
            <>
        ...
        {showTimer && (
          <div className="mt-3 text-center text-[13px] text-gray-500">
            Estimated time remaining: <span className="font-bold text-brand-blue ml-1">{formatTime(timeLeft)}</span>
          </div>
        )}
      </div>
    </div>
