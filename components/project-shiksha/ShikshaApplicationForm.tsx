        ...
        <main className="w-full bg-white rounded-2xl overflow-hidden relative order-2 lg:order-1">
          ...
          <section className="mb-12">
            ...
            <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
              <div className="grow grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5 order-2 md:order-1">
              ...
              <div className="w-full md:w-40 shrink-0 order-1 md:order-2 flex flex-col items-center md:items-start">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
              ...
              <div>
                ...
                <SelectArrow
                  ...
                  className="w-full border border-gray-300 rounded py-3 px-4 text-[15px] text-gray-800 outline-none focus:ring-0 focus:border-brand-blue transition-all bg-white cursor-pointer disabled:bg-gray-100 disabled:cursor-not-allowed"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5">
              ...
              <div className="col-span-1 sm:col-span-2">
                ...
                <input
                  ...
                  disabled={sameAsPermanent}
                  className="w-full border border-gray-300 rounded py-3 px-4 text-[15px] text-gray-800 outline-none focus:ring-0 focus:border-brand-blue transition-all bg-white disabled:bg-gray-100 disabled:cursor-not-allowed"
                  placeholder="Tole or village name"
                />
              </div>
            </div>
          ...
          <div className="mt-10 pt-6 border-t border-gray-200">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="w-5 h-5 mt-0.5 text-brand-blue rounded border-gray-300 focus:ring-0 focus:border-brand-blue cursor-pointer"
              />
