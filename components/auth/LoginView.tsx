    ...
    <div className="relative w-full max-w-110 mx-auto flex flex-col justify-center py-4 px-4">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-brand-blue hover:bg-blue-700 disabled:bg-blue-400 text-white font-medium rounded-md py-2.5 transition-colors duration-200 mt-2 flex items-center justify-center gap-2"
        >
          {loading ? (
