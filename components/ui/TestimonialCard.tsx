...
const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 relative overflow-hidden flex-shrink-0 w-[85vw] max-w-[350px] md:w-[400px] h-[400px] flex flex-col">
        ...
        <div className="flex items-start gap-4">
          <div className="w-[60px] h-[60px] rounded-full border-2 border-white overflow-hidden flex items-center justify-center flex-shrink-0 shadow-sm bg-blue-100">
            {imageUrl ? (
              ...
              >
                <path
                  d="M6 38C6 32 14 26 20 26C26 26 34 32 34 38"
                  fill="#0000ff"
                />
                <path
                  d="M10 40C10 33 15 28 20 28C25 28 30 33 30 40"
                  fill="#60a5fa"
                />
                <rect x="17" y="18" width="6" height="10" fill="#fca5a5" />
                <circle cx="20" cy="15" r="7" fill="#ffbda7" />
                <path
                  d="M13 14C13 9 17 6 20 6C23 6 27 9 27 14C27 15 28 17 25 18C25 15 22 13 20 13C18 13 15 15 15 18C12 17 13 15 13 14Z"
                  fill="#3f3f46"
                />
              </svg>
            )}
          ...
          <div className="flex flex-col mt-[-2px]">
            ...
            {role && (
              <h3 className="text-gray-600 font-medium text-[15px] mt-0.5">
                {role}
              </h3>
            )}
