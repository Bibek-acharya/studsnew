...
<section className="w-full py-8 sm:py-10 md:py-12 lg:py-14 px-4 sm:px-6 md:px-8">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 xl:gap-8">
    ...
    >
      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#e6f7ec] flex items-center justify-center mb-4 sm:mb-5 md:mb-6">
    ...
    >
      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#fceced] flex items-center justify-center mb-4 sm:mb-5 md:mb-6">
    ...
    <div
      className="bg-white rounded-xl p-5 sm:p-6 md:p-7 flex flex-col h-full hover:-translate-y-1 border border-gray-200 hover:border-blue-500/20 transition-all duration-300 cursor-pointer"
      onClick={() => onNavigate("scholarshipRecommenderTool")}
    >
      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#e7f0ff] flex items-center justify-center mb-4 sm:mb-5 md:mb-6">
      ...
      <h3 className="text-lg sm:text-xl font-bold text-[#0f172a] mb-2 sm:mb-3">Scholarship Recommender</h3>
      <p className="text-gray-500 text-[13px] sm:text-[14px] md:text-[15px] leading-relaxed mb-6 sm:mb-8 grow">
