...
<section className="w-full py-8 sm:py-10 md:py-12 lg:py-16">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 xl:gap-8">
    ...
    >
      ...
      <button className="w-full bg-brand-blue hover:bg-brand-hover text-white font-semibold py-3 sm:py-3.5 px-4 rounded-xl transition-colors duration-200 text-[13px] sm:text-[14px] md:text-[15px]">
        Start Comparison
      </button>
    </div>
