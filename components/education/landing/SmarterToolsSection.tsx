...
<section className="w-full py-8 sm:py-10 md:py-12 lg:py-14">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 xl:gap-8">
    <div
      className="bg-white rounded-md p-5 sm:p-6 md:p-7 flex flex-col h-full hover:-translate-y-1 border border-gray-200 hover:border-blue-500/20 transition-all duration-300 cursor-pointer"
      onClick={() => onNavigate("collegeRecommenderTool")}
    >
      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-md bg-[#e6f7ec] flex items-center justify-center mb-4 sm:mb-5 md:mb-6">
    ...
    >
      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-md bg-[#e7f0ff] flex items-center justify-center mb-4 sm:mb-5 md:mb-6">
        <svg className="w-6 h-6 sm:w-7 sm:h-7 text-brand-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div
      className="bg-white rounded-md p-7 card-shadow flex flex-col h-full hover:-translate-y-1 border border-gray-200 hover:border-blue-500/20 transition-transform duration-300"
      onClick={() => onNavigate("scholarshipFinderTool")}
    >
      <div className="w-14 h-14 rounded-md bg-[#fdf6e3] flex items-center justify-center mb-6">
      ...
      <button className="w-full bg-[#ebb316] hover:bg-[#d9a512] text-white font-semibold py-3.5 px-4 rounded-md transition-colors duration-200">
        Search Funding
      </button>
    </div>
    ...
    >
      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-md bg-[#fceced] flex items-center justify-center mb-4 sm:mb-5 md:mb-6">
      ...
      <button className="w-full bg-[#f04f53] hover:bg-[#e04044] text-white font-semibold py-3 sm:py-3.5 px-4 rounded-md transition-colors duration-200 text-[13px] sm:text-[14px] md:text-[15px]">
        Explore Courses
      </button>
    </div>
  </div>
