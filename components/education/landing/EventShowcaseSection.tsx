            ...
            {eventSlides.map((slide, index) => (
              ...
              >
                ...
                <div className="w-full lg:w-[45%] flex flex-col items-start pr-0 lg:pr-10">
                  <div
                    className={`inline-flex items-center gap-2 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full border mb-4 sm:mb-5 md:mb-6 ${slide.badgeClass || "bg-blue-50 border-blue-100 text-[#0000FF]"}`}
                  >
                    <svg className={`w-3.5 h-3.5 sm:w-4 sm:h-4 ${slide.badgeIconClass || "text-[#0000FF]"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
