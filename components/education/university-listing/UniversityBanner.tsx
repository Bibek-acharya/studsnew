      ...
      <div className="relative bg-white px-4 sm:px-0">
        <div className="relative mx-auto max-w-[1400px] pb-8">
          <div className="relative flex flex-row items-start gap-3 md:block">
            {/* Logo */}
            <div className="relative z-10 -mt-2 flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-md border border-gray-200 bg-white p-1.5 md:absolute md:-top-4 md:left-0 md:h-[150px] md:w-[150px]">
              {uni?.logo ? (
                <Image
                  src={uni.logo}
                  alt={`${name} logo`}
          ...
          <div className="grid grid-cols-3 gap-2 mt-4 md:hidden">
            <Link
              href={`/universities/${id}/affiliated-colleges`}
              className="flex items-center justify-center gap-2 rounded-md border border-gray-200 bg-brand-blue px-4 py-2.5 text-[13px] font-semibold text-white transition-colors hover:bg-brand-hover"
            >
              <Building2 className="h-4 w-4" />
              <span className="truncate">Colleges</span>
            </Link>
            {(aboutData?.prospectus_url as string) ? (
              <a
                href={aboutData?.prospectus_url as string}
              ...
              <button
                className="flex items-center justify-center gap-2 rounded-md border border-gray-200 bg-white px-4 py-2.5 text-[13px] font-semibold text-gray-400 cursor-not-allowed"
                disabled
              >
                <Download className="h-4 w-4" />
                <span className="truncate">Brochure</span>
