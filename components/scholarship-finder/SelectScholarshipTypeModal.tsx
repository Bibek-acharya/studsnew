        ...
        <div className="p-8 sm:p-10 pt-12">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className="w-full sm:w-1/2 px-5 py-3.5 bg-blue-600 text-white font-semibold rounded-md shadow-sm hover:bg-blue-700 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-blue-600 shadow-blue-500/30"
            >
              Apply Filter
            </button>
          </div>
