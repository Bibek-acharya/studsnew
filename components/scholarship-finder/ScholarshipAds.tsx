...
export const SponsoredBanner: React.FC<AdBannerProps> = ({ title, subtitle, buttonText, onButtonClick }) => (
  <div className="col-span-1 md:col-span-2 lg:col-span-3 w-full flex flex-col items-center mt-3 mb-5">
    <div className="w-full relative bg-linear-to-r from-white via-[#f0f6ff] to-[#e4f0ff] border border-[#dceaff] rounded-md p-6 md:p-8 flex flex-col md:flex-row items-center justify-between overflow-hidden shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)]">
      ...
      <div className="flex flex-col items-center gap-2 z-10 shrink-0 mb-6 md:mb-0 md:ml-4">
        <div className="w-16 h-16 bg-white border border-gray-100 rounded-md  flex items-center justify-center p-2">
      ...
      <div className="flex flex-col items-center md:items-start text-center md:text-left z-10 max-w-2xl px-0 md:px-10 grow">
        ...
        <button onClick={onButtonClick} className="bg-[#514df0] hover:bg-[#4338ca] text-white text-[14px] font-semibold px-6 py-2.5 rounded-full transition-colors flex items-center gap-2  shadow-blue-500/20">
          {buttonText}
...
export const JobCard: React.FC<JobCardProps> = ({ title, company, subtitle, buttonText, onButtonClick }) => (
  <div className="flex-1 min-h-45 bg-linear-to-br from-[#ebe5f6] to-[#d8d0ea] rounded-md flex overflow-hidden  flex-col sm:flex-row">
    <div className="bg-white w-full sm:w-37.5 shrink-0 flex flex-col items-center justify-center text-center p-5 rounded-none sm:rounded-r-[60px] z-10">
      <div className="w-12.5 h-12.5 bg-white border border-gray-100 rounded-md  flex flex-col items-center justify-center mb-3 overflow-hidden relative">
