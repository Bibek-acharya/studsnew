...
const SudsphereBannerAd: React.FC = () => {
  ...
  return (
    <div
      className="relative w-full h-auto md:h-[220px] rounded-lg overflow-hidden flex items-center shadow-lg"
      style={{
    ...
    >
      {/* Background decorations: rings + wave blob */}
      <div className="absolute border border-white/15 rounded-full w-[300px] h-[300px] -top-[150px] right-[10%] pointer-events-none" />
      <div className="absolute border-[0.5px] border-white/15 rounded-full w-[400px] h-[400px] -top-[200px] right-[5%] pointer-events-none" />
