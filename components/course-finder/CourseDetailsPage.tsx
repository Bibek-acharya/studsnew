...
const CourseDetailsPage: React.FC<CourseDetailsPageProps> = ({
  ...
  useEffect(() => {
    const affiliationId = course?.affiliationId;
  ...
  return (
    <>
      ...
      <div className="w-full bg-white">
        ...
        <div className="px-6 md:px-12 lg:px-24 xl:px-32 pt-8 md:pt-12 pb-6 md:pb-8">
          {/* Breadcrumb */}
          ...
          {courseBannerUrl ? (
            <div
              ...
              style={{
                backgroundImage: `url('${courseBannerUrl}')`,
        ...
        <div className="px-6 md:px-12 lg:px-24 xl:px-32 bg-white sticky top-0 z-40">
          <div className="relative">
            ...
            >
              <nav className="flex space-x-4 md:space-x-8 whitespace-nowrap border-b border-gray-100">
                {TAB_LIST.map((tab) => (
                  <button
                    key={tab.id}
        ...
        <div className="px-6 md:px-12 lg:px-24 xl:px-32 py-8 md:py-12 grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 bg-white">
          {/* Main Content */}
