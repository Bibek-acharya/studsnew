...
export const SearchBar: React.FC<{
  ...
  return (
    <div
      className={
        isMobile ? "w-full" : " hidden max-w-480 flex-1 md:block"
      }
    >
      <div className="group relative flex h-10 w-full items-center overflow-visible rounded-full border border-gray-300 bg-white transition-all focus-within:border-[#4461f2] sm:h-11.5">
