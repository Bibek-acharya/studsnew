...
type FeaturedCollegeCardProps = React.ComponentProps<typeof FeaturedCollegeCard>;

interface FeaturedAdmissionAdProps {
  colleges: FeaturedCollegeCardProps[];
}

const FeaturedAdmissionAd: React.FC<FeaturedAdmissionAdProps> = ({ colleges }) => {
  const placement = getAdPlacement("admissions-featured");
