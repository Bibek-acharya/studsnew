    ...
    <div className="bg-white rounded-md  w-full flex flex-col border border-gray-100 hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-300 overflow-hidden group/card relative">
      ...
      <div className="p-3.5 flex flex-col flex-grow relative">
        ...
        <div className="flex items-center justify-between mb-3">
          <a href={website?.startsWith("http") ? website : `https://${website}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-[12px] text-[#1053F3] font-medium hover:underline">
