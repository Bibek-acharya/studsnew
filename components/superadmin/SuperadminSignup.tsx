        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-3xl shadow-2xl p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="John"
                    className="w-full bg-slate-950/50 border border-slate-800 focus:border-blue-600/60 focus:ring-4 focus:ring-blue-600/10 focus:outline-none rounded-xl py-2.5 pl-10 pr-3 text-white placeholder:text-slate-600 transition-all text-sm"
                  />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Doe"
                  className="w-full bg-slate-950/50 border border-slate-800 focus:border-blue-600/60 focus:ring-4 focus:ring-blue-600/10 focus:outline-none rounded-xl py-2.5 px-4 text-white placeholder:text-slate-600 transition-all text-sm"
                />
              </div>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="••••••••"
                    className="w-full bg-slate-950/50 border border-slate-800 focus:border-blue-600/60 focus:ring-4 focus:ring-blue-600/10 focus:outline-none rounded-xl py-2.5 pl-10 pr-10 text-white placeholder:text-slate-600 transition-all text-sm"
                  />
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="••••••••"
                    className="w-full bg-slate-950/50 border border-slate-800 focus:border-blue-600/60 focus:ring-4 focus:ring-blue-600/10 focus:outline-none rounded-xl py-2.5 px-4 pr-10 text-white placeholder:text-slate-600 transition-all text-sm"
                  />
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-950/50 border border-blue-900/30 focus:border-blue-500 focus:ring-4 focus:ring-blue-600/10 focus:outline-none rounded-xl py-2.5 pl-10 pr-3 text-white placeholder:text-slate-700 transition-all text-sm font-mono tracking-widest"
                />
              </div>
            </div>
            ...
            <button
              ...
              type="submit"
              disabled={loading}
              className="w-full relative group overflow-hidden bg-blue-600 hover:bg-blue-500 disabled:bg-slate-800 disabled:text-slate-600 text-white font-bold py-4 rounded-2xl shadow-xl shadow-blue-900/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2 mt-2"
            >
