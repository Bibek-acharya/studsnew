    ...
    async (asDraft: boolean) => {
      ...
      try {
        ...
        if (isEditing && editId) {
          ...
          toast.success(
            asDraft ? "Blog updated as draft." : "Blog updated successfully.",
          );
        } else {
          await superadminBlogApi.create(payload);
          toast.success(
            asDraft ? "Blog saved as draft." : "Blog published successfully.",
          );
        }
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              type="text"
              className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500"
              placeholder="education, scholarship, nepal (comma separated)"
              value={tags}
