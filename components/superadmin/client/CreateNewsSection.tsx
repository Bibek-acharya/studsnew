...
export default function CreateNewsSection({ setActiveSection, editId }: { setActiveSection: (s: string) => void; editId?: number }) {
      ...
      <div className="bg-white rounded-lg p-8 border border-slate-100">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input type="text" className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500" placeholder="admission, scholarship, nepal (comma separated)" value={tags} onChange={(e) => setTags(e.target.value)} />
          </div>
        </div>
      </div>
