      ...
      .then((json) => {
        ...
        if (contactData) {
          ...
          if (contactData.socials)
            setContactSocials(withId(contactData.socials));
    ...
    <div className="flex-1 overflow-y-auto bg-gray-50/50 p-4 md:p-8 font-sans">
      <form onSubmit={handleSubmit}>
        <div className="max-w-[90rem] mx-auto space-y-8">
          ...
          <div className="bg-white p-6 rounded-md border border-gray-200">
            <h3 className="text-lg font-semibold text-gray-800 mb-5">
              <i className="fa-solid fa-user-tie text-blue-500 mr-2"></i>Key
              Personnel
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setViceChancellor(e.target.value)}
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div className="mt-6">
              <div className="flex justify-between items-center mb-3">
                ...
                <button
                  type="button"
                  onClick={() =>
                    addItem(setContactSocials, { platform: "", url: "" })
                  }
                  className="text-sm text-blue-600 bg-blue-50 px-3 py-1.5 rounded-md hover:bg-blue-100 transition-colors font-medium"
                >
              ...
              <div className="space-y-3">
                {contactSocials.map((s) => (
                  ...
                  >
                    <button
                      type="button"
                      onClick={() => removeItem(setContactSocials, s.id)}
                      className="absolute top-3 right-3 text-red-400 hover:text-red-600 hover:bg-red-50 p-1.5 rounded-md transition-colors opacity-0 group-hover:opacity-100"
                    >
                      <i className="fa-solid fa-trash"></i>
                    </button>
          ...
          <div className="bg-white p-6 rounded-md border border-gray-200">
            <div className="flex justify-between items-center mb-5">
              <h3 className="text-lg font-semibold text-gray-800">
                <i className="fa-solid fa-graduation-cap text-blue-500 mr-2"></i>
                Programs
              </h3>
              <button
                type="button"
            ...
            <div className="space-y-4">
              {programs.map((p) => (
                ...
                >
                  <button
                    type="button"
                    onClick={() => removeItem(setPrograms, p.id)}
                    className="absolute top-3 right-3 text-red-400 hover:text-red-600 hover:bg-red-50 p-1.5 rounded-md transition-colors opacity-0 group-hover:opacity-100"
                  >
                    <i className="fa-solid fa-trash"></i>
                  </button>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pr-10">
                    <input
                      ...
                      value={p.name}
                      onChange={(e) =>
                        updateItem(setPrograms, p.id, "name", e.target.value)
                      }
                    />
                    <input
                      type="text"
                      ...
                      value={p.level}
                      onChange={(e) =>
                        updateItem(setPrograms, p.id, "level", e.target.value)
                      }
                    />
                    <input
                      type="text"
                    ...
                    <input
                      ...
                      value={p.status}
                      onChange={(e) =>
                        updateItem(setPrograms, p.id, "status", e.target.value)
                      }
                    />
                  </div>
                </div>
              ...
              {programs.length === 0 && (
                <p className="text-sm text-gray-400 py-2">No programs added.</p>
              )}
            </div>
          </div>
            ...
            <div className="space-y-4">
              {events.map((ev) => (
                ...
                >
                  <button
                    type="button"
                    onClick={() => removeItem(setEvents, ev.id)}
                    className="absolute top-3 right-3 text-red-400 hover:text-red-600 hover:bg-red-50 p-1.5 rounded-md transition-colors opacity-0 group-hover:opacity-100"
                  >
                    <i className="fa-solid fa-trash"></i>
                  </button>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pr-10">
                    <input
                      ...
                      value={ev.title}
                      onChange={(e) =>
                        updateItem(setEvents, ev.id, "title", e.target.value)
                      }
                    />
                    <input
                      type="text"
                      className={`${inputClass} text-sm`}
                      placeholder="Date (e.g. 2025-05-15)"
                      value={ev.date}
                      onChange={(e) =>
                        updateItem(setEvents, ev.id, "date", e.target.value)
                      }
                    />
                    <input
                      type="text"
                      ...
                      value={ev.time}
                      onChange={(e) =>
                        updateItem(setEvents, ev.id, "time", e.target.value)
                      }
                    />
                    <input
                      type="text"
                      ...
                      value={ev.venue}
                      onChange={(e) =>
                        updateItem(setEvents, ev.id, "venue", e.target.value)
                      }
                    />
                    <div className="md:col-span-2">
                      <input
              ...
              {events.length === 0 && (
                <p className="text-sm text-gray-400 py-2">No events added.</p>
              )}
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-md border border-gray-200">
            <div className="flex justify-between items-center mb-5">
              <h3 className="text-lg font-semibold text-gray-800">
                <i className="fa-solid fa-newspaper text-blue-500 mr-2"></i>News
                & Notices
              </h3>
              <button
                type="button"
            ...
            <div className="space-y-4">
              {news.map((n) => (
                ...
                >
                  <button
                    type="button"
                    onClick={() => removeItem(setNews, n.id)}
                    className="absolute top-3 right-3 text-red-400 hover:text-red-600 hover:bg-red-50 p-1.5 rounded-md transition-colors opacity-0 group-hover:opacity-100"
                  >
                    <i className="fa-solid fa-trash"></i>
                  </button>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pr-10">
                    <input
                      ...
                      value={n.title}
                      onChange={(e) =>
                        updateItem(setNews, n.id, "title", e.target.value)
                      }
                    />
                    <input
                      type="text"
                      className={`${inputClass} text-sm`}
                      placeholder="Category (e.g. Exam, Admission)"
                      value={n.category}
                      onChange={(e) =>
                        updateItem(setNews, n.id, "category", e.target.value)
                      }
                    />
                    <input
                      type="text"
                      ...
                      value={n.date}
                      onChange={(e) =>
                        updateItem(setNews, n.id, "date", e.target.value)
                      }
                    />
                    <div className="md:col-span-2">
                      <input
                        ...
                        value={n.image_url}
                        onChange={(e) =>
                          updateItem(setNews, n.id, "image_url", e.target.value)
                        }
                      />
                    </div>
              ...
              {news.length === 0 && (
                <p className="text-sm text-gray-400 py-2">No news added.</p>
              )}
            </div>
          </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pr-10">
                    ...
                    <input
                      ...
                      value={d.type}
                      onChange={(e) =>
                        updateItem(setDownloads, d.id, "type", e.target.value)
                      }
                    />
                    <input
                      type="url"
                      ...
                      value={d.url}
                      onChange={(e) =>
                        updateItem(setDownloads, d.id, "url", e.target.value)
                      }
                    />
                  </div>
                </div>
