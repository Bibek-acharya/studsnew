...
export default function SuperadminEntranceApplicantsSection({
  setActiveSection,
}: {
  ...
  useEffect(() => {
    ...
    superadminEntranceApi
      .getApplicants(Number(selectedEntrance))
      .then(setApplicants)
      .catch(() => setApplicants([]));
  }, [selectedEntrance]);
  ...
  applicants.forEach((a) => {
    tabCounts[a.status] = (tabCounts[a.status] || 0) + 1;
  });
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 min-h-full">
      <SectionHeader
        ...
        breadcrumbItems={[{ label: "Dashboard" }, { label: "Applicants" }]}
      />
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6 border-b border-gray-200 flex flex-wrap items-center gap-4">
          <select
            ...
            onChange={(e) => {
              setSelectedEntrance(e.target.value ? Number(e.target.value) : "");
              setPage(1);
            }}
        ...
        {!selectedEntrance ? (
          <div className="text-center py-12 text-gray-400">
            <p className="text-sm">
              Select an entrance exam to view applicants
            </p>
          </div>
        ) : loading ? (
          <div className="text-center py-12 text-gray-400">
          ...
          <div className="text-center py-12 text-gray-400">
            <p className="text-sm">No applicants found for this entrance.</p>
          </div>
        ) : (
          <>
