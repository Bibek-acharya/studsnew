                ...
                <tr className="bg-slate-50 border-b border-slate-200">
                  <th className="text-left px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">
                    ...
                    >
                      Institution
                      <ChevronDown
                        className={`w-3 h-3 transition-transform ${sortKey === "institution" && sortDir === "desc" ? "rotate-180" : ""}`}
                      />
                    </button>
                  </th>
                  <th className="text-left px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">
                  ...
                  <th className="text-center px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">
                    ...
                    >
                      Status
                      <ChevronDown
                        className={`w-3 h-3 transition-transform ${sortKey === "status" && sortDir === "desc" ? "rotate-180" : ""}`}
                      />
                    </button>
                  </th>
                  <th className="text-left px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">
                    ...
                    >
                      Applied
                      <ChevronDown
                        className={`w-3 h-3 transition-transform ${sortKey === "appliedDate" && sortDir === "desc" ? "rotate-180" : ""}`}
                      />
                    </button>
                  </th>
                  <th className="text-left px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">
                    ...
                    >
                      Deadline
                      <ChevronDown
                        className={`w-3 h-3 transition-transform ${sortKey === "deadline" && sortDir === "desc" ? "rotate-180" : ""}`}
                      />
                    </button>
                  </th>
                  <th className="text-center px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">
              ...
              <tbody>
                {sorted.map((app) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <span
                        className={`text-xs font-bold px-2 py-1 rounded-full ${STATUS_COLOR[app.status]} capitalize`}
                      >
            ...
            {sorted.length === 0 && (
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p className="text-sm text-slate-500 max-w-sm">
                  Start by exploring colleges and scholarships.
                </p>
              </div>
            )}
          </>
          ...
          <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white border-l border-slate-200 z-[70] animate-in slide-in-from-right duration-300">
            <div className="h-full flex flex-col">
              ...
              <div className="p-6 border-b border-slate-100">
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-14 h-14 rounded-md ${TYPE_COLOR[selected.type]} flex items-center justify-center`}
                    >
              ...
              <div className="flex-1 overflow-y-auto p-6">
                ...
                <div className="mb-6">
                  <span
                    className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-bold ${STATUS_COLOR[selected.status]}`}
                  >
                    ...
                    {STATUS_ORDER.map((s, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="pb-4">
                            <p
                              className={`text-sm font-semibold ${isDone ? "text-slate-800" : "text-slate-400"}`}
                            >
                              {STATUS_LABEL[s]}
                            </p>
                            {isCurrent && (
