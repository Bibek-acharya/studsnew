            ...
            <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm flex flex-col justify-between">
              ...
              <div className="text-xs text-gray-500 flex items-center gap-1 mt-2">
                {stats?.applications_submitted ? (
                  <>
                    <span className="text-green-500 font-medium bg-green-50 px-1.5 py-0.5 rounded">
                      +{stats.applications_submitted}
                    </span>{" "}
                    total
                  </>
            ...
            <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm flex flex-col justify-between">
              ...
              <div className="text-xs text-gray-500 flex items-center gap-1 mt-2">
                {stats?.active_invites ? (
                  <>
                    <span className="text-purple-500 font-medium bg-purple-50 px-1.5 py-0.5 rounded">
                      {stats.active_invites}
                    </span>{" "}
                    pending
                  </>
                    ...
                    {recentApps.map((app, idx) => (
                      <tr key={app.id || idx} className="hover:bg-gray-50">
                        <td className="px-5 py-3">
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-8 h-8 rounded flex items-center justify-center font-bold text-xs ${getInitialBg(app.institution)}`}
                            >
                              {getCollegeInitial(app.institution)}
                            </div>
                            <span className="text-sm font-medium text-gray-900">
                              {app.institution || "Unknown College"}
                            </span>
                          </div>
                        </td>
