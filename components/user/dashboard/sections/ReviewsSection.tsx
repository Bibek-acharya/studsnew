...
export default function ReviewsSection() {
  ...
  const [reviewTab, setReviewTab] = useState<"college" | "application">(
    "college",
  );
          ...
          <section className="bg-white rounded-md  border border-gray-100 p-6">
            ...
            {filteredReviews.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">
                  You haven't reviewed any college yet
                </h3>
                      ...
                      <div className="flex flex-wrap gap-2 mb-2">
                        {review.pros && (
                          <span className="inline-flex items-center gap-1 bg-green-50 text-green-700 px-2 py-1 rounded text-xs font-medium border border-green-100">
                            + {review.pros.slice(0, 30)}
                            {review.pros.length > 30 ? "..." : ""}
                          </span>
                        )}
                        {review.cons && (
                          <span className="inline-flex items-center gap-1 bg-red-50 text-red-700 px-2 py-1 rounded text-xs font-medium border border-red-100">
                            - {review.cons.slice(0, 30)}
                            {review.cons.length > 30 ? "..." : ""}
                          </span>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      ...
                      {selectedReview.studentType && (
                        <p className="text-sm text-gray-400">
                          {selectedReview.studentType} • {selectedReview.level}{" "}
                          • Batch {selectedReview.batchYear}
                        </p>
                      )}
                    </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <textarea
                        value={editForm.pros}
                        onChange={(e) =>
                          setEditForm({ ...editForm, pros: e.target.value })
                        }
                        rows={3}
                    ...
                    <div>
                      ...
                      <textarea
                        value={editForm.cons}
                        onChange={(e) =>
                          setEditForm({ ...editForm, cons: e.target.value })
                        }
                        rows={3}
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-sm">
              <div className="bg-white rounded-md shadow-xl w-full max-w-sm text-center p-6 md:p-8">
                ...
                <p className="text-gray-500 mb-6 text-sm">
                  ...
                  {selectedReview.collegeName}? This action cannot be undone.
                </p>
