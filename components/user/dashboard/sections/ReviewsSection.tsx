...
import { Star, Eye, Pencil, Trash2, XCircle, MessageSquareText } from 'lucide-react'
...
const mockReviews: Review[] = [
  {
    ...
    rating: 5,
    title: "Incredible campus, rigorous academics",
    pros: "World-class faculty, Silicon Valley networking, Beautiful campus",
    cons: "High tuition & living costs, Intense competition",
    date: "2026-04-10"
  },
  {
    id: 2,
    ...
    pros: "Unmatched academics, Research opportunities, Prestigious degree",
    cons: "Heavy workload, Stressful environment",
    date: "2026-03-22"
  },
  {
    id: 3,
    ...
    course: "MBA",
    rating: 3,
    title: "Great location, but felt impersonal",
    pros: "NYC Location, Strong alumni network",
    cons: "Extremely expensive, Bureaucratic administration, Lack of traditional campus",
    date: "2026-02-15"
  },
  {
    id: 4,
    college: "Online Tech Academy",
    course: "Full Stack Bootcamp",
    rating: 2,
    title: "Outdated curriculum",
    pros: "Flexible schedule",
    cons: "Outdated materials, Poor mentorship, Low value for money",
    date: "2026-01-05"
  }
]
...
function getRatingDisplay(rating: number) {
  ...
  const displayRating = decimalMap[rating] || "0.0"
  return (
              ...
              >
                <div className="p-5 flex-grow">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <h3 className="font-bold text-gray-900 leading-tight">{review.college}</h3>
                      {review.course && (
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto relative">
            ...
            <div className="p-6 md:p-8">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">{selectedReview.college}</h2>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="World-class faculty, Research opportunities"
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-shadow"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="High tuition, Heavy workload"
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-shadow"
                  />
                </div>
              </div>
