        ...
        <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] flex flex-col">
          ...
          <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 flex-shrink-0">
            ...
            {applicant.status === "shortlisted" && (
              <span className="inline-flex items-center gap-2 px-4 py-2 border-2 border-green-500 text-green-700 rounded-lg text-sm font-medium bg-green-50">
            ...
            {applicant.status === "rejected" && (
              <span className="inline-flex items-center gap-2 px-4 py-2 border-2 border-red-500 text-red-700 rounded-lg text-sm font-medium bg-red-50">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
