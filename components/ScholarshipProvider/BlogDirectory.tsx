        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              {filtered.length === 0 ? (
                <tr><td colSpan={6} className="py-8 text-center text-gray-500">No blogs found</td></tr>
              ) : filtered.map((blog) => (
                <tr key={blog.id} className="hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4">
                    ...
                    <p className="text-xs text-gray-500">{blog.content ? new DOMParser().parseFromString(blog.content, 'text/html').body.textContent?.slice(0, 60) : ''}</p>
                  </td>
