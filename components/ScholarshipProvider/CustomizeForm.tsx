...
const CustomizeForm: React.FC = memo(() => {
  const [sections, setSections] = useState<FieldSection[]>([
    ...
    },
    {
      ...
      description: "Guardian and parent occupation details",
      icon: Users,
      ...
      fields: [
        { id: "guardian-name", label: "Guardian's Name", type: "text", required: true },
        { id: "guardian-phone", label: "Guardian's Phone Number", type: "tel", required: true },
        { id: "guardian-email", label: "Guardian's Email", type: "email", required: false },
