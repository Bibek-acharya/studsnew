...
const CreateEvent: React.FC<CreateEventProps> = memo(
  ({ eventId, onNavigate, onEditComplete }) => {
      ...
      async (draft: boolean) => {
        ...
        try {
          ...
          if (isEditing && eventId) {
            ...
            toast.success(
              draft
                ? "Your event has been updated as a draft."
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Sowers Action Nepal Office, Kathmandu"
                  value={venue}
                  onChange={(e) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500"
                  placeholder="e.g., Sowers Action Nepal"
                  value={organizedBy}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500"
                  placeholder="event, workshop, nepal (comma separated)"
                  value={tags}
