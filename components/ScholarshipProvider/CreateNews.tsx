...
const CreateNews: React.FC<CreateNewsProps> = memo(
  ({ newsId, onNavigate, onEditComplete }) => {
      ...
      async (draft: boolean) => {
        ...
        try {
          ...
          if (isEditing && newsId) {
            ...
            toast.success(
              draft
                ? "Your news post has been updated as a draft."
            ...
            toast.success(
              draft
                ? "Your news post has been saved as a draft."
                : "Your news has been published in the directory.",
            );
          }
          onEditComplete?.();
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500"
                  placeholder="news, event, nepal (comma separated)"
                  value={tags}
