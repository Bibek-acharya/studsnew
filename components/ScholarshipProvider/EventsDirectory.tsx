...
const FALLBACK_EVENTS: ProviderEvent[] = [
  {
    id: 1,
    provider_id: 1,
    name: "Leadership Training 2026",
    short_desc: "Leadership workshop",
    description: "3-day intensive leadership workshop",
    image_url:
    ...
    max_participants: 50,
    online_link: "",
    organized_by: "Youth Center",
    contact_person: "John Doe",
    contact_email: "john@example.com",
    start_date: "2026-04-25T09:00:00",
    end_date: "2026-04-27T16:00:00",
    location: "Kathmandu",
  ...
  },
  {
    ...
    short_desc: "Communication workshop",
    ...
    max_participants: 30,
    online_link: "",
    organized_by: "Storytellers Guild",
  ...
  },
  {
    id: 3,
    provider_id: 1,
    name: "Children's Day Celebration 2025",
    short_desc: "Community celebration",
  ...
  },
  {
    id: 4,
    provider_id: 1,
    name: "Earthquake Preparedness Drill",
    short_desc: "Safety drill",
    description: "Community safety preparedness",
    image_url: null,
    event_type: "Seminar",
    category: "Safety",
    max_participants: 200,
    online_link: "",
    organized_by: "Disaster Management Office",
    contact_person: "Robert Brown",
    contact_email: "robert@example.com",
    start_date: "2026-04-12T08:00:00",
    end_date: "2026-04-12T12:00:00",
    location: "Lalitpur",
  ...
  },
  {
    ...
    short_desc: "Health checkup camp",
    description: "Free health check-ups for residents",
    image_url: null,
    event_type: "Program",
    category: "Health",
    max_participants: 150,
    online_link: "",
    organized_by: "Health Foundation",
    contact_person: "Sarah Wilson",
    contact_email: "sarah@example.com",
    start_date: "2026-05-05T07:00:00",
    end_date: "2026-05-05T14:00:00",
    location: "Bhaktapur",
    tags: ["health", "medical"],
    enable_registration: true,
    status: "upcoming",
...
const EventsDirectory: React.FC<EventsDirectoryProps> = memo(
  ({ onView, onEdit }) => {
        ...
        <div className="bg-white rounded-lg p-8 border border-slate-100">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-lg font-bold text-gray-900 flex items-center gap-2">
              <CalendarDays className="w-5 h-5 text-blue-600" /> Events
              Directory
            </h2>
