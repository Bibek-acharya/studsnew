...
const FALLBACK_EVENTS: ProviderEvent[] = [
  ...
  { id: 2, provider_id: 1, name: "Storytelling Workshop", short_desc: "Communication workshop", description: "Effective communication for leaders", image_url: null, event_type: "Workshop", category: "Skills", max_participants: 30, online_link: "", organized_by: "Storytellers Guild", contact_person: "Jane Smith", contact_email: "jane@example.com", start_date: "2025-09-17T10:00:00", end_date: "2025-09-17T15:00:00", location: "Pokhara", tags: ["storytelling"], enable_registration: false, status: "completed", attendees: 0, created_at: "", updated_at: "" },
  { id: 3, provider_id: 1, name: "Children's Day Celebration 2025", short_desc: "Community celebration", description: "Annual celebration with community", image_url: null, event_type: "Program", category: "Community", max_participants: 100, online_link: "", organized_by: "NGO Alliance", contact_person: "Mike Johnson", contact_email: "mike@example.com", start_date: "2025-09-17T11:00:00", end_date: "2025-09-17T17:00:00", location: "Kathmandu", tags: ["children", "celebration"], enable_registration: false, status: "completed", attendees: 0, created_at: "", updated_at: "" },
  { id: 4, provider_id: 1, name: "Earthquake Preparedness Drill", short_desc: "Safety drill", description: "Community safety preparedness", image_url: null, event_type: "Seminar", category: "Safety", max_participants: 200, online_link: "", organized_by: "Disaster Management Office", contact_person: "Robert Brown", contact_email: "robert@example.com", start_date: "2026-04-12T08:00:00", end_date: "2026-04-12T12:00:00", location: "Lalitpur", tags: ["safety", "emergency"], enable_registration: true, status: "upcoming", attendees: 0, created_at: "", updated_at: "" },
  { id: 5, provider_id: 1, name: "Community Health Camp", short_desc: "Health checkup camp", description: "Free health check-ups for residents", image_url: null, event_type: "Program", category: "Health", max_participants: 150, online_link: "", organized_by: "Health Foundation", contact_person: "Sarah Wilson", contact_email: "sarah@example.com", start_date: "2026-05-05T07:00:00", end_date: "2026-05-05T14:00:00", location: "Bhaktapur", tags: ["health", "medical"], enable_registration: true, status: "upcoming", attendees: 0, created_at: "", updated_at: "" },
];
...
const EventsDirectory: React.FC<EventsDirectoryProps> = memo(({ onView, onEdit }) => {
              ...
              {filtered.length === 0 ? (
                ...
                <tr key={event.id} className="hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4">
                    ...
                    {event.short_desc ? (
                      <p className="text-xs text-gray-500" dangerouslySetInnerHTML={{ __html: event.short_desc.slice(0, 60) + (event.short_desc.length > 60 ? '...' : '') }} />
                    ) : (
                      <p className="text-xs text-gray-500">{event.description?.replace(/<[^>]*>/g, '').slice(0, 60)}</p>
                    )}
                  </td>
                  ...
                  <td className="text-center py-3 px-4">
                    <div className="flex items-center justify-center gap-2">
                      <button className="p-1.5 hover:bg-blue-50 rounded text-blue-600" title="View" onClick={() => onView?.(event.id)}><Eye className="w-4 h-4" /></button>
                      <button className="p-1.5 hover:bg-green-50 rounded text-green-600" title="Edit" onClick={() => onEdit?.(event.id)}><Pencil className="w-4 h-4" /></button>
