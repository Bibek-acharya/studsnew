...
const FALLBACK_NEWS: ProviderNews[] = [
  ...
  { id: 2, provider_id: 1, title: "Leadership Training 2026 Completed", short_desc: "Workshop concludes successfully", content: "3-day workshop with 50+ participants", image_url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800&h=400", news_type: "update", published_by: "Youth Center", publish_date: "2026-03-31", tags: ["training", "leadership"], allow_comments: false, status: "published", published_at: "2026-03-31", created_at: "2026-03-31", updated_at: "" },
  { id: 3, provider_id: 1, title: "Scholarship Partnership with 100 Group", short_desc: "New partnership announced", content: "Nationwide program for underprivileged students", image_url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800&h=400", news_type: "press-release", published_by: "Partnership Office", publish_date: "2025-10-27", tags: ["scholarship", "partnership"], allow_comments: true, status: "published", published_at: "2025-10-27", created_at: "2025-10-27", updated_at: "" },
  { id: 4, provider_id: 1, title: "Leadership Training Workshop Highlights", short_desc: "Key takeaways from workshop", content: "Storytelling for effective leadership", image_url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800&h=400", news_type: "news", published_by: "Training Institute", publish_date: "2025-09-17", tags: ["workshop", "storytelling"], allow_comments: true, status: "published", published_at: "2025-09-17", created_at: "2025-09-17", updated_at: "" },
  { id: 5, provider_id: 1, title: "Children's Day Celebration 2025", short_desc: "Community celebration recap", content: "Joyful celebration with community children", image_url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800&h=400", news_type: "announcement", published_by: "Community Center", publish_date: "2025-09-17", tags: ["children", "celebration"], allow_comments: false, status: "published", published_at: "2025-09-17", created_at: "2025-09-17", updated_at: "" },
];

const NEWS_TYPES: Record<string, string> = {
  notice: "Notice", announcement: "Announcement", news: "News",
  "press-release": "Press Release", update: "Update",
};
      ...
      <div className="bg-white rounded-lg p-8 border border-slate-100">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="relative w-64">
            ...
            <input type="text" className="w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500" placeholder="Search news..." value={search} onChange={(e) => setSearch(e.target.value)} />
          </div>
        </div>
                ...
                return (
                  <tr key={item.id} className="hover:bg-gray-50">
                    <td className="py-3 px-4">
                      <img src={item.image_url || "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800&h=400"} alt={item.title} className="w-20 h-14 object-cover rounded-lg border border-gray-200" />
                    </td>
                    <td className="py-3 px-4">
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between mt-6">
            <p className="text-sm text-gray-500">Showing <span className="font-medium">{(page - 1) * limit + 1}-{Math.min(page * limit, total)}</span> of <span className="font-medium">{total}</span> news</p>
