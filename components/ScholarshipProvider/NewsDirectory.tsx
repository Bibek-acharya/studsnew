...
const FALLBACK_NEWS: ProviderNews[] = [
  { id: 1, provider_id: 1, title: "Government Announces New Education Policy", content: "Ministry unveils comprehensive policy framework", image_url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800&h=400", status: "published", published_at: new Date(Date.now() - 3 * 86400000).toISOString(), created_at: new Date(Date.now() - 3 * 86400000).toISOString(), updated_at: "" },
  { id: 2, provider_id: 1, title: "Leadership Training 2026 Completed", content: "3-day workshop with 50+ participants", image_url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800&h=400", status: "published", published_at: "2026-03-31", created_at: "2026-03-31", updated_at: "" },
  { id: 3, provider_id: 1, title: "Scholarship Partnership with 100 Group", content: "Nationwide program for underprivileged students", image_url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800&h=400", status: "published", published_at: "2025-10-27", created_at: "2025-10-27", updated_at: "" },
  { id: 4, provider_id: 1, title: "Leadership Training Workshop Highlights", content: "Storytelling for effective leadership", image_url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800&h=400", status: "published", published_at: "2025-09-17", created_at: "2025-09-17", updated_at: "" },
  { id: 5, provider_id: 1, title: "Children's Day Celebration 2025", content: "Joyful celebration with community children", image_url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800&h=400", status: "published", published_at: "2025-09-17", created_at: "2025-09-17", updated_at: "" },
];
