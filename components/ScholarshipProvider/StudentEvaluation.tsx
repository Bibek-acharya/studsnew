...
export default function StudentEvaluation({ applicationId, onBack, onStatusUpdate }: StudentEvaluationProps) {
    ...
    return (
      <div className="fade-in max-w-7xl mx-auto">
        <div className="bg-red-50 border border-red-200 rounded-md p-6 text-red-700">
          ...
          <button onClick={onBack} className="mt-4 px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 font-bold text-sm">
            Go Back
          </button>
        </div>
      </div>
          ...
          <div className="space-y-10 fade-in">
            ...
            {application.scholarship && (
              <div>
                ...
                <div className="bg-primary-50 p-6 rounded-md border border-primary-100">
            ...
            {application.documents ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {(Array.isArray(application.documents) ? application.documents : []).map((doc: any, i: number) => (
                  <div key={i} className="p-4 bg-white border border-slate-200 rounded-md  hover: transition text-center group cursor-pointer">
                    <div className="w-16 h-16 bg-slate-50 text-slate-400 rounded-md flex items-center justify-center mx-auto mb-3 group-hover:bg-primary-50 group-hover:text-primary-600 transition">
        ...
        return (
          <div className="space-y-6 fade-in">
            ...
            {application.personal_statement ? (
              <div className="bg-slate-50 p-8 rounded-md border border-slate-200 italic text-slate-700 leading-relaxed font-serif shadow-inner">
                "{application.personal_statement}"
  ...
  return (
    <div className="fade-in max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-white p-4 rounded-md border border-slate-200 ">
        ...
        <div className="flex flex-wrap gap-2 w-full md:w-auto">
          <button className="flex-1 md:flex-none px-4 py-2 border border-slate-300 text-slate-700 bg-white rounded-md hover:bg-slate-50 font-bold text-sm  flex items-center justify-center gap-2">
          ...
          <select
            ...
            className="flex-1 md:flex-none border border-slate-300 rounded-md px-4 py-2 text-sm font-bold bg-white  outline-none cursor-pointer focus:border-primary-500 disabled:opacity-50"
          >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 items-start">
        <div className="space-y-6 xl:col-span-1">
          <div className="bg-white p-6 rounded-md border border-slate-200  text-center relative overflow-hidden">
            ...
            <button className="w-full py-2.5 bg-indigo-50 text-indigo-700 border border-indigo-200 rounded-md hover:bg-indigo-100 text-sm font-extrabold transition flex items-center justify-center gap-2 ">
            ...
            <div className="p-5 bg-slate-50 space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full h-2 bg-slate-200 rounded-md appearance-none cursor-pointer accent-primary-600"
                />
              </div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="mt-2 w-full py-2.5 bg-primary-600 text-white rounded-md hover:bg-primary-700  transition font-bold text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {saving ? (
        ...
        <div className="xl:col-span-3 bg-white rounded-md border border-slate-200  overflow-hidden flex flex-col min-h-[700px]">
