...
const partners = [
  ...
  { src: "https://projectshiksha.hundredgroupnepal.org/images/sower-hk.jpeg", alt: "Sowers Hong Kong" },
  { src: "https://projectshiksha.hundredgroupnepal.org/images/ronb.jpg", alt: "RONB" },
  { src: "https://projectshiksha.hundredgroupnepal.org/images/ncell.png", alt: "Ncell" },
  { src: "https://projectshiksha.hundredgroupnepal.org/images/creating.png", alt: "Creating Opportunities" },
    ...
    <div>
      <main className="flex-grow flex flex-col items-center px-4 overflow-x-hidden pt-8 md:pt-12">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-full px-6 pb-12 md:pb-16 flex flex-col md:flex-row justify-center items-start md:items-center gap-10 md:gap-16 max-w-6xl mx-auto right-0 z-20 pointer-events-none">
            <div className="flex items-center gap-4">
              <div className="flex items-start">
                <span className="counter text-white text-4xl md:text-6xl font-extrabold tracking-tight leading-none drop-shadow-sm" data-target="10">0</span>
                <span className="text-[#0000ff] text-3xl md:text-5xl font-extrabold tracking-tight leading-none ml-1 drop-shadow-sm">K+</span>
              </div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-start">
                <span className="counter text-white text-4xl md:text-6xl font-extrabold tracking-tight leading-none drop-shadow-sm" data-target="500">0</span>
                <span className="text-[#0000ff] text-3xl md:text-5xl font-extrabold tracking-tight leading-none ml-1 drop-shadow-sm">+</span>
              </div>
              <div className="text-white/90 text-sm md:text-base leading-snug tracking-wide flex flex-col justify-center font-medium">
        ...
        <section className="mb-20 md:mb-32 w-full max-w-7xl px-2 md:px-6 flex flex-col items-center">
          ...
          <div className="w-full flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 relative">
            <div className="hidden md:flex flex-col items-center order-1 mt-[-40px] animate-float">
              ...
              />
              <div className="name-badge text-white text-center font-semibold min-w-[110px]" style={{ backgroundColor: "#0A61EF" }}>
                Santosh
              </div>
            </div>
            ...
            <div className="hidden md:flex flex-col items-center order-3 mt-[-40px] animate-float" style={{ animationDelay: "1s" }}>
              <img
                ...
                className="w-[90px] h-[90px] rounded-full object-cover border-4 border-white shadow-lg z-10"
              />
              <div className="name-badge text-white text-center font-semibold min-w-[110px]" style={{ backgroundColor: "#8476F1" }}>
                Jagdish
              </div>
            </div>
          </div>
          ...
          <div className="flex md:hidden flex-wrap justify-center gap-8 mt-10">
            <div className="flex flex-col items-center animate-float">
              ...
              />
              <div className="name-badge text-white text-center font-semibold min-w-[100px] text-xs" style={{ backgroundColor: "#0A61EF" }}>
                Santosh
              </div>
            </div>
            <div className="flex flex-col items-center animate-float" style={{ animationDelay: "1s" }}>
              <img
                ...
                className="w-[80px] h-[80px] rounded-full object-cover border-4 border-white shadow-lg z-10"
              />
              <div className="name-badge text-white text-center font-semibold min-w-[100px] text-xs" style={{ backgroundColor: "#8476F1" }}>
                Jagdish
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center mt-8 md:mt-12 animate-float" style={{ animationDelay: "2s" }}>
            ...
            />
            <div className="name-badge text-white text-center font-semibold min-w-[100px] md:min-w-[110px] text-xs md:text-sm" style={{ backgroundColor: "#EEAE85" }}>
              Badal
            </div>
          </div>
        </section>
        ...
        <section className="w-full max-w-350 mb-20 md:mb-32 px-2">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-slate-900 mb-8 md:mb-12">Our Story, Mission &amp; Vision</h2>
        ...
        <section className="w-full max-w-350 mb-20 md:mb-32 px-2">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 py-8 lg:py-16">
            ...
            >
              <div className="flex w-max animate-scroll-ltr group-hover:[animation-play-state:paused]">
                <div className="flex gap-8 sm:gap-12 items-center justify-items-center shrink-0 pr-8 sm:pr-12">
                  {partners.map((p, i) => (
                    <img key={i} src={p.src} alt={p.alt} className="h-14 w-auto object-contain flex-shrink-0" />
                  ))}
                </div>
                <div className="flex gap-8 sm:gap-12 items-center justify-items-center shrink-0 pr-8 sm:pr-12">
                  {partners.map((p, i) => (
                    <img key={`dup-${i}`} src={p.src} alt={p.alt} className="h-14 w-auto object-contain flex-shrink-0" />
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-[35%] flex flex-col items-start text-left mt-8 lg:mt-0 px-4 lg:px-0">
              <h2 className="text-[32px] md:text-[38px] font-extrabold text-gray-900 leading-tight mb-4" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                Our Valuable Partners
              </h2>
              <p className="text-gray-500 text-[15px] leading-relaxed mb-8 max-w-[95%]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                We collaborate with industry-leading platforms and tools to deliver seamless, integrated, and powerful experiences for our users.
              </p>
              <div className="flex flex-wrap items-center gap-6">
                ...
                <a href="/partners" className="text-[#0000ff] font-medium text-sm">
                  View All Partners
                </a>
              </div>
            </div>
          ...
          >
            ...
            >
              <div className="p-6 md:p-8 pt-7 flex flex-col items-center justify-center h-full min-h-[300px]">
                ...
                <h3 className="text-blue-600 font-bold text-lg mb-2">Write a Review</h3>
                <p className="text-gray-500 text-[14px] text-center mb-4">Share your experience and help others make informed decisions.</p>
                <button
          ...
          <div className="bg-white rounded-2xl w-full max-w-[550px] max-h-[90vh] overflow-y-auto relative">
            ...
            <div className="px-6 sm:px-10 py-8">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  onClick={() => { setShowReviewModal(false); setSelectedRating(0); }}
                    ...
                    {[1, 2, 3, 4, 5].map((star) => (
                      <span
                        ...
                        className={`transition-colors ${
                          star <= (hoverRating || selectedRating) ? "text-yellow-400" : "text-gray-300"
                        }`}
      ...
      {showPartnerModal && (
        ...
        >
          <div className="bg-white rounded-2xl w-full max-w-[550px] max-h-[90vh] overflow-y-auto relative">
            <div className="px-6 sm:px-10 py-8">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-[22px] font-bold text-[#1e293b]">Partner With Us</h2>
                <button
              ...
              <form className="space-y-5" onSubmit={handlePartnerSubmit}>
                <div>
                  <label className="block text-[14px] font-semibold text-gray-700 mb-1.5">Organization Name <span className="text-red-500">*</span></label>
                  <input
                    type="text"
                    className="w-full border border-gray-300 rounded py-3 px-4 text-[15px] text-gray-800 outline-none focus:border-[#0000ff] transition-all bg-white"
                ...
                <div>
                  <label className="block text-[14px] font-semibold text-gray-700 mb-1.5">Contact Person <span className="text-red-500">*</span></label>
                  <input
                    type="text"
                    className="w-full border border-gray-300 rounded py-3 px-4 text-[15px] text-gray-800 outline-none focus:border-[#0000ff] transition-all bg-white"
                    placeholder="Enter your full name"
                ...
                <div>
                  <label className="block text-[14px] font-semibold text-gray-700 mb-1.5">Type of Partnership</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[14px] font-semibold text-gray-700 mb-1.5">Email <span className="text-red-500">*</span></label>
                    <input
                      type="email"
                      className="w-full border border-gray-300 rounded py-3 px-4 text-[15px] text-gray-800 outline-none focus:border-[#0000ff] transition-all bg-white"
                  ...
                  <div>
                    <label className="block text-[14px] font-semibold text-gray-700 mb-1.5">Phone <span className="text-red-500">*</span></label>
                    <input
                      type="tel"
                      className="w-full border border-gray-300 rounded py-3 px-4 text-[15px] text-gray-800 outline-none focus:border-[#0000ff] transition-all bg-white"
                ...
                <div>
                  <label className="block text-[14px] font-semibold text-gray-700 mb-1.5">Message</label>
                  <textarea
                    className="w-full border border-gray-300 rounded py-3 px-4 text-[15px] text-gray-800 outline-none focus:border-[#0000ff] transition-all bg-white resize-none"
                    rows={4}
