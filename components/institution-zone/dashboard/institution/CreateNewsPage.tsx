...
import { Newspaper, FloppyDisk, PaperPlaneTilt, Image } from "@phosphor-icons/react";
    ...
    <div className="p-4 md:p-6 lg:p-8">
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
          <label className="block text-sm font-medium text-gray-700 mb-1.5">News Title</label>
          <input
            type="text"
            value={title}
