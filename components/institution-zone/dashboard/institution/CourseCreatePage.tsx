      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="p-6 space-y-5">
            <div>
              <label className={labelClass}>Banner Image <span className="text-red-500">*</span></label>
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">Full name of the course</p>
            </div>
            <div>
          ...
          <div className="p-6 space-y-4">
            {whoShouldChoose.map((w) => (
              <div key={w.id} className="p-5 bg-gray-50 rounded-lg border border-gray-200 relative group">
                <button
                  onClick={() => setWhoShouldChoose((prev) => prev.filter((x) => x.id !== w.id))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pr-12">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="relative flex-1">
                        <input
                          ...
                          onChange={(e) =>
                            setWhoShouldChoose((prev) =>
                              prev.map((x) => (x.id === w.id ? { ...x, icon: e.target.value } : x))
                            )
                          }
                        />
                      </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setWhoShouldChoose((prev) =>
                          prev.map((x) => (x.id === w.id ? { ...x, shortDesc: e.target.value } : x))
                        )
                      }
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 pr-12">
                  ...
                  <div className="md:col-span-6">
                    ...
                    <input
                      type="text"
                      className={inputClass}
                      placeholder="e.g. Covers all essential topics with practical examples"
                      value={f.shortDesc}
                      onChange={(e) =>
                        setFeatures((prev) =>
                          prev.map((x) => (x.id === f.id ? { ...x, shortDesc: e.target.value } : x))
                        )
                      }
                    />
                  </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <SectionItemHeader
            ...
            subtitle="Define eligibility requirements with level, stream, and documents"
            onAdd={() =>
          ...
          <div className="p-6 space-y-6">
            {eligibilityRows.map((ec) => (
              <div key={ec.id} className="p-5 bg-gray-50 rounded-lg border border-gray-200 relative group">
                <button
                  onClick={() => setEligibilityRows((prev) => prev.filter((x) => x.id !== ec.id))}
                  className="absolute top-4 right-4 p-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors"
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
                </button>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="border-b border-gray-200 bg-gray-50/50 px-6 py-4 flex items-center justify-between gap-4">
            ...
            <button
              onClick={() =>
                setFullTimeCourses((prev) => [...prev, { id: nextId(prev), course: "", totalFees: "", startDate: "", endDate: "" }])
              }
              className="px-3 py-1.5 text-sm font-medium text-blue-600 bg-white border border-gray-200 rounded-lg hover:bg-blue-50 flex items-center gap-1.5 transition-colors shadow-sm shrink-0"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <tr key={ft.id} className="hover:bg-gray-50">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setFullTimeCourses((prev) =>
                              prev.map((x) => (x.id === ft.id ? { ...x, course: e.target.value } : x))
                            )
                          }
                        />
                      </td>
                      <td className="px-4 py-2 border-b border-gray-200">
                        <input
                          ...
                          onChange={(e) =>
                            setFullTimeCourses((prev) =>
                              prev.map((x) => (x.id === ft.id ? { ...x, totalFees: e.target.value } : x))
                            )
                          }
                        />
                      </td>
                      <td className="px-4 py-2 border-b border-gray-200">
                        <input
                          ...
                          onChange={(e) =>
                            setFullTimeCourses((prev) =>
                              prev.map((x) => (x.id === ft.id ? { ...x, startDate: e.target.value } : x))
                            )
                          }
                        />
                      </td>
                      <td className="px-4 py-2 border-b border-gray-200">
                        <input
                          ...
                          onChange={(e) =>
                            setFullTimeCourses((prev) =>
                              prev.map((x) => (x.id === ft.id ? { ...x, endDate: e.target.value } : x))
                            )
                          }
                        />
                      </td>
                      <td className="px-4 py-2 text-right border-b border-gray-200">
                        <button
                          onClick={() => setFullTimeCourses((prev) => prev.filter((x) => x.id !== ft.id))}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <SectionItemHeader
            ...
            subtitle="Define subject groups, streams, and career paths"
            onAdd={() =>
              setSubjectGroups((prev) => [
                ...prev,
                { id: nextId(prev), groupName: "", description: "", subjects: [], careers: [] },
              ])
            }
            addLabel="Add Group"
          />
          <div className="p-6 space-y-6">
            {subjectGroups.map((sg) => (
              <div key={sg.id} className="p-5 bg-gray-50 rounded-lg border border-gray-200 relative group">
                <button
                  onClick={() => setSubjectGroups((prev) => prev.filter((x) => x.id !== sg.id))}
                  className="absolute top-4 right-4 p-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors"
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
                </button>
                <div className="pr-12 space-y-4">
                  <div>
                    ...
                    <input
                      type="text"
                      className={inputClass}
                      placeholder="e.g. Physical Group, Biology Group"
                      value={sg.groupName}
                      onChange={(e) =>
                        setSubjectGroups((prev) =>
                          prev.map((x) => (x.id === sg.id ? { ...x, groupName: e.target.value } : x))
                        )
                      }
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSubjectGroups((prev) =>
                          prev.map((x) => (x.id === sg.id ? { ...x, description: e.target.value } : x))
                        )
                      }
                    />
                  </div>
                    ...
                    <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setSubjectGroups((prev) =>
                                prev.map((x) =>
                                  x.id === sg.id
                                    ? { ...x, subjects: (x.subjects || []).map((v, j) => j === si ? e.target.value : v) }
                                    : x
                                )
                              )
                            }
                          ...
                          <button
                            onClick={() =>
                              setSubjectGroups((prev) =>
                                prev.map((x) =>
                                  x.id === sg.id
                                    ? { ...x, subjects: (x.subjects || []).filter((_, j) => j !== si) }
                                    : x
                                )
                              )
                            }
                      ...
                      <button
                        onClick={() =>
                          setSubjectGroups((prev) =>
                            prev.map((x) =>
                              x.id === sg.id ? { ...x, subjects: [...(x.subjects || []), ""] } : x
                            )
                          )
                        }
                        className="text-sm text-blue-600 hover:text-blue-800 flex items-center gap-1"
                    ...
                    <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setSubjectGroups((prev) =>
                                prev.map((x) =>
                                  x.id === sg.id
                                    ? { ...x, careers: (x.careers || []).map((v, j) => j === ci ? e.target.value : v) }
                                    : x
                                )
                              )
                            }
                      ...
                      <button
                        onClick={() =>
                          setSubjectGroups((prev) =>
                            prev.map((x) =>
                              x.id === sg.id ? { ...x, careers: [...(x.careers || []), ""] } : x
                            )
                          )
                        }
                        className="text-sm text-blue-600 hover:text-blue-800 flex items-center gap-1"
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <SectionItemHeader
            ...
            onAdd={() =>
              setFeeItems((prev) => [
                ...prev,
                { id: nextId(prev), particular: "", amount: "", frequency: "", notes: "" },
              ])
            }
          ...
          <div className="p-6 space-y-4">
            {feeItems.map((fi) => (
              <div key={fi.id} className="p-5 bg-gray-50 rounded-lg border border-gray-200 relative group">
                <button
                  onClick={() => setFeeItems((prev) => prev.filter((x) => x.id !== fi.id))}
                  className="absolute top-4 right-4 p-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors"
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
                </button>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pr-12">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFeeItems((prev) =>
                          prev.map((x) => (x.id === fi.id ? { ...x, particular: e.target.value } : x))
                        )
                      }
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFeeItems((prev) =>
                          prev.map((x) => (x.id === fi.id ? { ...x, amount: e.target.value } : x))
                        )
                      }
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFeeItems((prev) =>
                          prev.map((x) => (x.id === fi.id ? { ...x, frequency: e.target.value } : x))
                        )
                      }
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFeeItems((prev) =>
                          prev.map((x) => (x.id === fi.id ? { ...x, notes: e.target.value } : x))
                        )
                      }
                    />
                  </div>
            ...
            <div className="space-y-4">
              {scholarships.map((s, idx) => (
                <div key={s.id} className="p-5 bg-gray-50 rounded-lg border border-gray-200 relative group">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-4 pr-12">
                    <div className="md:col-span-1">
                      <label className={labelClass}>#</label>
                      <input
                        type="text"
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        type="text"
                        className={inputClass}
                        placeholder="e.g. For +2 Science Students"
                        value={s.subtitle}
                        onChange={(e) =>
                          setScholarships((prev) =>
                    ...
                    <div className="md:col-span-3">
                      <label className={labelClass}>Requirement <span className="text-red-500">*</span></label>
                      <input
                        type="text"
                        className={inputClass}
                        ...
                        onChange={(e) =>
                          setScholarships((prev) =>
                            prev.map((x) => (x.id === s.id ? { ...x, requirement: e.target.value } : x))
                          )
                        }
                      />
                    </div>
              ...
              <button
                onClick={() =>
                  setScholarships((prev) => [
                    ...prev,
                    { id: nextId(prev), title: "", subtitle: "", coverage: "", requirement: "" },
                  ])
                }
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <SectionItemHeader
            ...
            subtitle="Common questions and answers about the course"
            onAdd={() =>
              setFaqs((prev) => [
                ...prev,
              ...
              <div key={f.id} className="p-5 bg-gray-50 rounded-lg border border-gray-200 relative group flex flex-col gap-4">
                ...
                <div className="space-y-1.5 pr-12">
                  ...
                  <input
                    type="text"
                    className={inputClass}
                    placeholder="e.g. What are the subjects in this program?"
                    value={f.question}
                    onChange={(e) =>
                      setFaqs((prev) =>
