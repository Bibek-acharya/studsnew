      ...
      <div className="max-w-5xl mx-auto mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button 
            type="button" 
            onClick={onBack}
            className="w-10 h-10 bg-white border border-gray-200 rounded-md flex items-center justify-center text-gray-500 hover:text-gray-900 "
          >
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="bg-white p-6 rounded-md  border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" placeholder="Enter scholarship title" value={title} onChange={e => setTitle(e.target.value)} required />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Provider Name</label>
                <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" placeholder="e.g. ABC Foundation" value={provider} onChange={e => setProvider(e.target.value)} required />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Tags (Status)</label>
                <select className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" value={status} onChange={e => setStatus(e.target.value)}>
              ...
              <div>
                ...
                <select className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" value={type} onChange={e => setType(e.target.value)}>
              ...
              <div>
                ...
                <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" placeholder="e.g. New York, USA" value={location} onChange={e => setLocation(e.target.value)} />
              </div>
              <div>
          ...
          <div className="bg-white p-6 rounded-md  border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                <input type="date" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" value={deadline} onChange={e => setDeadline(e.target.value)} />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Apply Now Link</label>
                <input type="url" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" placeholder="External link or leave blank for internal" value={link} onChange={e => setLink(e.target.value)} />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Field of Study</label>
                <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" placeholder="e.g. Computer Science, Medicine" value={field} onChange={e => setField(e.target.value)} />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Funding Amount</label>
                <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" placeholder="e.g. $5,000 or Full Tuition" value={amount} onChange={e => setAmount(e.target.value)} />
              </div>
            </div>
            
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">Scholarship Features</label>
              <textarea className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors h-20" placeholder="Short features highlights..." value={features} onChange={e => setFeatures(e.target.value)}></textarea>
            </div>

            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">About the Scholarship (Description)</label>
              <textarea className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors h-32" placeholder="Full description..." value={description} onChange={e => setDescription(e.target.value)}></textarea>
            </div>
            
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Brief Eligibility Summary</label>
              <textarea className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors h-20" placeholder="Summary of who can apply..." value={summary} onChange={e => setSummary(e.target.value)}></textarea>
            </div>
          </div>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-3">
                {eligibility.map(item => (
                  <div key={item.id} className="bg-gray-50 border border-gray-200 rounded-md p-4 relative group">
                    ...
                    <div className="flex items-center mb-3 pr-10">
                      ...
                      <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md font-medium text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" placeholder="Heading (e.g. Academic Requirement)" value={item.heading} onChange={e => updateItem(setEligibility, item.id, 'heading', e.target.value)} />
                    </div>
                    <textarea className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors h-16" placeholder="Subheading / Description" value={item.desc} onChange={e => updateItem(setEligibility, item.id, 'desc', e.target.value)}></textarea>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="space-y-3">
                {regions.map(item => (
                  <div key={item.id} className="bg-gray-50 border border-gray-200 rounded-md p-4 relative group">
                    ...
                    <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md font-medium text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors mb-3 pr-10" placeholder="Subheading (e.g. EU Citizens excluded)" value={item.heading} onChange={e => updateItem(setRegions, item.id, 'heading', e.target.value)} />
                    <textarea className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors h-16" placeholder="Note (Add reasons or specific details)" value={item.note} onChange={e => updateItem(setRegions, item.id, 'note', e.target.value)}></textarea>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="space-y-2">
                {documents.map(item => (
                  <div key={item.id} className="flex gap-3 items-center">
                    <input type="text" className="w-full px-3 py-2.5 border border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" placeholder="Document Name (e.g. Identity Proof)" value={item.name} onChange={e => updateItem(setDocuments, item.id, 'name', e.target.value)} />
                    <button type="button" onClick={() => removeItem(setDocuments, item.id)} className="text-red-400 hover:text-red-600 p-2.5 transition-colors bg-red-50 hover:bg-red-100 rounded-md shrink-0">
                      <i className="fa-solid fa-trash"></i>
                    </button>
                  </div>
                ))}
                ...
                {timeline.map(item => (
                  <div key={item.id} className="bg-gray-50 border border-gray-200 rounded-md p-4 relative group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3 pr-10">
                      <input type="date" className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors md:col-span-1" value={item.date} onChange={e => updateItem(setTimeline, item.id, 'date', e.target.value)} />
                      <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md font-medium text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors md:col-span-2" placeholder="Date Heading (e.g. Interview Phase)" value={item.heading} onChange={e => updateItem(setTimeline, item.id, 'heading', e.target.value)} />
                    </div>
                    <textarea className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors h-16" placeholder="Subheading / Detailed information about this phase" value={item.desc} onChange={e => updateItem(setTimeline, item.id, 'desc', e.target.value)}></textarea>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="space-y-3">
                {processes.map(item => (
                  <div key={item.id} className="bg-gray-50 border border-gray-200 rounded-md p-4 relative group">
                    ...
                    <textarea className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors h-16" placeholder="Step Description" value={item.desc} onChange={e => updateItem(setProcesses, item.id, 'desc', e.target.value)}></textarea>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="bg-white p-6 rounded-md  border border-gray-200">
                ...
                {benefits.map(item => (
                  <div key={item.id} className="bg-gray-50 border border-gray-200 rounded-md p-4 relative group">
                    ...
                    <div className="flex gap-2 mb-3 pr-10">
                      <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md font-mono text-xs focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors flex-1" placeholder="Icon (fa-book)" value={item.icon} onChange={e => updateItem(setBenefits, item.id, 'icon', e.target.value)} />
                      <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md font-medium text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors flex-[2]" placeholder="Benefit Heading" value={item.heading} onChange={e => updateItem(setBenefits, item.id, 'heading', e.target.value)} />
                    </div>
                    <textarea className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors h-16" placeholder="Benefit Subheading" value={item.sub} onChange={e => updateItem(setBenefits, item.id, 'sub', e.target.value)}></textarea>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <input type="url" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" placeholder="e.g. YouTube URL" value={videoUrl} onChange={e => setVideoUrl(e.target.value)} />
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-2">
                {applySteps.map(item => (
                  <div key={item.id} className="flex gap-3 items-center">
                    <input type="text" className="w-full px-3 py-2.5 border border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" placeholder="Instruction Step (e.g. Register on the portal)" value={item.instruction} onChange={e => updateItem(setApplySteps, item.id, 'instruction', e.target.value)} />
                    <button type="button" onClick={() => removeItem(setApplySteps, item.id)} className="text-red-400 hover:text-red-600 p-2.5 transition-colors bg-red-50 hover:bg-red-100 rounded-md shrink-0">
                      <i className="fa-solid fa-trash"></i>
                    </button>
                  </div>
                ))}
              ...
              <div className="space-y-3">
                {faqs.map(item => (
                  <div key={item.id} className="bg-gray-50 border border-gray-200 rounded-md p-4 relative group">
                    ...
                    <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-md font-medium text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors mb-3 pr-10" placeholder="Question?" value={item.q} onChange={e => updateItem(setFaqs, item.id, 'q', e.target.value)} />
                    <textarea className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors h-16" placeholder="Answer..." value={item.a} onChange={e => updateItem(setFaqs, item.id, 'a', e.target.value)}></textarea>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="flex items-center justify-end space-x-4 pt-6 mt-8 border-t border-gray-200 pb-10">
            <button type="button" onClick={onBack} className="px-6 py-2.5 bg-white border border-gray-300 rounded-md text-gray-700 font-medium hover:bg-gray-50 transition ">
              Cancel
            </button>
            ...
            <button type="submit" className="px-6 py-2.5 bg-blue-600 text-white rounded-md font-medium hover:bg-blue-700 transition  flex items-center">
