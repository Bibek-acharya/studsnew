      ...
      <div className="max-w-125 w-full bg-white rounded-2xl border border-gray-200 p-6 sm:p-10 shadow-sm relative overflow-hidden">
          ...
          <div className="bg-blue-50/30 border border-blue-100 rounded-xl p-4">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1 text-[13px] space-y-1.5 pt-1">
                ...
                <p className="flex justify-between">
                  ...
                  <span className="font-bold text-brand-blue">{scholarship?.paymentConfig?.bank_details?.account_number || "01234567890123"}</span>
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-brand-blue file:text-white hover:file:bg-brand-blue/80 cursor-pointer border border-gray-200 rounded-md bg-white transition-colors"
              />
              {paymentScreenshot && (
            ...
            <div className="space-y-4 mt-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" value={applicantName} onChange={(e) => setApplicantName(e.target.value)} className="w-full border-2 border-gray-200 rounded-md pl-10 pr-4 py-2.5 text-sm focus:border-brand-blue outline-none transition-colors bg-white" placeholder="Full Name" required />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" value={contactNumber} onChange={(e) => setContactNumber(e.target.value.replace(/[^0-9]/g, "").slice(0, 10))} className="w-full border-2 border-gray-200 rounded-md pl-10 pr-4 py-2.5 text-sm tracking-wide focus:border-brand-blue outline-none transition-colors bg-white" placeholder="9840000000" maxLength={10} required />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full bg-gray-50 border border-gray-200 rounded-xl p-5 mb-6 shadow-sm">
          ...
          <div className="border-t border-gray-200 pt-3 flex justify-between items-center">
            ...
            <span className="font-bold text-xl text-brand-blue">{scholarship?.paymentConfig?.currency || "Rs."} {feeAmount}.00</span>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full bg-brand-blue hover:bg-brand-blue/80 disabled:bg-gray-400 text-white font-bold py-4 px-6 rounded-xl transition duration-200 flex items-center justify-center gap-2 disabled:cursor-not-allowed"
        >
          {isProcessing ? (
            <>
