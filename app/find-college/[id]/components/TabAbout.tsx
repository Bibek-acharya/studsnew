...
import { AboutVideoInteractive, InfoBlock, OverviewRow, AdminRow } from "./index";
...
const TabAbout: React.FC<TabAboutProps> = ({
  ...
  const hasData = description || (Array.isArray(instVideos) && instVideos.length > 0) || instVision || instMission ||
  ...
  return (
    <div className="space-y-10">
      ...
      {description && (
        <div className="prose prose-gray max-w-none text-[15px] leading-[1.8] md:text-[16px] break-words">
