...
const Step = ({ number, title, description }: StepProps) => (
  <div className="flex gap-4">
    ...
    <div>
      ...
      <p className="text-[14px] text-gray-600 mt-1.5 leading-relaxed">{description}</p>
    </div>
  </div>
);
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="mb-6">
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight mb-3 text-gray-900 leading-tight">
            KIST College opens college visits and registration for top-25 merit scholarships
          </h1>
        ...
        <div className="flex flex-wrap gap-2 mb-10 sm:mb-12">
          <span className="px-3 py-1 rounded-md text-xs font-semibold bg-emerald-50 text-emerald-700">Admission Open</span>
          <span className="px-3 py-1 rounded-md text-xs font-semibold bg-blue-50 text-blue-700">NEB</span>
          <span className="px-3 py-1 rounded-md text-xs font-semibold bg-indigo-50 text-indigo-700">2 YRS</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-10 lg:gap-16">
          ...
          <article className="space-y-12">
            ...
            <div className="border border-gray-100 bg-white rounded-2xl p-6 sm:p-8 shadow-sm">
              <div className="flex items-start justify-between cursor-pointer">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="text-[13px] text-gray-500 font-medium tracking-wide uppercase">KIST College Admissions</span>
                    <h2 className="text-xl sm:text-[22px] font-bold text-[#111827] mt-0.5">What&apos;s new?</h2>
                  </div>
                </div>
              ...
              <div className="mt-6 text-gray-700 text-[15px] leading-relaxed">
                <p className="mb-4 text-[16px]">All the latest updates regarding <span className="font-semibold text-gray-900">KIST College admissions 2026</span> are as follows:</p>
                <ul className="list-disc pl-5 space-y-3 mb-8 text-gray-600">
                  <li>The Registration for Grade 11 is expected to start in Aug, 2026 for admission to the Science, Management, and Humanities courses.</li>
                  <li>The Pre-Registration portal is active. Students need to log in to the official college portal to reserve their seats early and access their dashboard.</li>
                  <li>The KIST Entrance Examination registration link is active for admission to the +2 programmes. The round 1 window to view offers and make a decision will be opened on <span className="font-semibold text-gray-900">May 11, 2026</span> (10 AM).</li>
                </ul>
            ...
            <section>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Admissions Now Open for New Session</h2>
              <p className="text-[17px] leading-relaxed text-gray-700">
                KIST College announces the official opening of admissions for the upcoming academic session. We invite prospective students to explore our comprehensive programs in Science, Management, and Humanities. Our institution is dedicated to fostering an environment of academic excellence, critical thinking, and holistic development. With state-of-the-art facilities, highly qualified faculty, and a robust curriculum, KIST prepares students to meet global challenges and excel in their chosen career paths.
              </p>
            </section>
            ...
            <section>
              <div className="flex items-center gap-3 mb-6">
                <div className="relative w-10 h-10 flex-shrink-0">
                  <div className="absolute top-0 left-0 w-7 h-7 bg-[#fbd38d] rounded-lg flex items-center justify-center font-bold text-[#dd6b20] text-sm">Q</div>
                  <div className="absolute bottom-0 right-0 w-7 h-7 bg-[#fca5a5] rounded-lg flex items-center justify-center font-bold text-[#b91c1c] text-sm shadow-sm">A</div>
                </div>
                <h2 className="text-2xl font-bold text-gray-900">Commonly asked questions</h2>
              </div>
            ...
            <section className="scroll-mt-20">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">KIST College of Science Fees & Eligibility</h2>
              <p className="text-gray-500 mb-6 text-[15px]">Updated for 2026 Academic Session</p>
                ...
                <table className="w-full text-left border-collapse min-w-[800px]">
                  <thead>
                    <tr className="bg-[#eff4fc] text-[15px]">
                      <th className="p-5 font-bold text-[#111827] w-[28%] border-r border-gray-100">Course</th>
                      <th className="p-5 font-bold text-[#111827] w-[22%] border-r border-gray-100">Total Fees</th>
                      <th className="p-5 font-bold text-[#111827] w-[20%] border-r border-gray-100">Eligibility</th>
                      <th className="p-5 font-bold text-[#111827] w-[15%] border-r border-gray-100">Application Date</th>
                      <th className="p-5 font-bold text-[#111827] w-[15%]">Action</th>
                    </tr>
                  </thead>
                  <tbody className="text-[14px] text-gray-700">
                    {[
                      { name: "Science (+2)", eligibility: "SEE passed with minimum 2.5 GPA", date: "Aug 2026" },
                      { name: "Management (+2)", eligibility: "SEE passed with minimum 2.5 GPA", date: "Aug 2026" },
                      { name: "Humanities (+2)", eligibility: "SEE passed with minimum 2.5 GPA", date: "Aug 2026" },
                    ].map((course, idx) => (
                      <tr key={idx} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors last:border-0">
                        <td className="p-5 align-top border-r border-gray-50">
                          <div className="text-gray-900 font-bold mb-1.5">{course.name}</div>
                          <button className="text-[#2563eb] text-[13px] hover:underline flex items-center font-medium">
                            View Curriculum <ArrowRight className="w-3 h-3 ml-1" />
                          </button>
                        </td>
                        <td className="p-5 align-top border-r border-gray-50">
                          <div className="text-emerald-600 font-semibold mb-1.5">Contact College for Details</div>
                          <button className="text-[#2563eb] text-[13px] hover:underline flex items-center font-medium">
                            Check Details <ArrowRight className="w-3 h-3 ml-1" />
                          </button>
                        </td>
                        <td className="p-5 align-top border-r border-gray-50 leading-relaxed">{course.eligibility}</td>
                        <td className="p-5 align-top border-r border-gray-50 font-medium">{course.date}</td>
            ...
            <section className="bg-[#f8fafc] rounded-3xl p-8 sm:p-10">
              <h2 className="text-2xl font-bold text-[#111827] mb-6">KIST College Admission Process 2026</h2>
              <div className="text-gray-700 text-[16px] leading-relaxed space-y-6">
                <p>As per the <span className="font-semibold text-gray-900">KIST College admission criteria</span> for +2 (or Bachelor&apos;s), students with a valid SEE/NEB score that matches the <button className="text-[#2563eb] hover:underline font-medium">KIST College cutoff</button> are selected and given a seat. Students have to complete the <button className="text-[#2563eb] hover:underline font-medium">college application process</button> and take the test.</p>

                <div className="space-y-4">
                  <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                    <CheckCircle className="w-5 h-5 text-emerald-500" /> Registration Process 2026
                  </h3>
                  <p className="text-gray-600">Fill an online application form at the KIST College site with all the relevant details around the personal and educational details. Students must appear and qualify for the accepted entrance exam before applying.</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">KIST College selects students mainly on an entrance basis for all courses. The selection rounds include application screening, entrance test, and personal interview.</p>
                  
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    {[
                      { title: "Science (+2)", steps: "SEE + Entrance + Interview" },
                      { title: "Management (+2)", steps: "Screening + Entrance + Interview" },
                    ].map((item, idx) => (
                      <li key={idx} className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                        <span className="font-bold text-gray-900 block mb-1">{item.title}</span>
                        <span className="text-[13px] text-gray-500">{item.steps}</span>
                      </li>
                    ))}
                  </ul>
                </div>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Scholarships Overview</h2>
              
              <div className="overflow-x-auto rounded-2xl border border-gray-100 bg-white">
                <table className="w-full text-left border-collapse min-w-[800px]">
                  <thead>
                    <tr className="bg-[#eff4fc]">
                      <th className="p-5 font-bold text-gray-900 w-[20%] border-r border-gray-100">Scholarship</th>
                      <th className="p-5 font-bold text-gray-900 w-[12%] border-r border-gray-100">Level</th>
                      <th className="p-5 font-bold text-gray-900 w-[15%] border-r border-gray-100">Stream</th>
                      <th className="p-5 font-bold text-gray-900 w-[12%] border-r border-gray-100">Coverage</th>
                      <th className="p-5 font-bold text-gray-900 w-[20%] border-r border-gray-100">Eligibility</th>
                      <th className="p-5 font-bold text-gray-900 w-[10%] border-r border-gray-100">Seats</th>
                      <th className="p-5 font-bold text-gray-900 w-[12%]">Action</th>
                    </tr>
                  </thead>
                  <tbody className="text-[14px]">
                    {[
                      { name: "Merit Scholarship", level: "+2", stream: "Science", coverage: "100%", eligibility: "GPA 3.8+", seats: "2" },
                      { name: "Entrance Topper", level: "+2", stream: "All", coverage: "50%", eligibility: "Top 5 rank", seats: "5" },
                    ].map((s, idx) => (
                      <tr key={idx} className="border-b border-gray-50 last:border-0 hover:bg-gray-50/50 transition-colors">
                        <td className="p-5 align-top border-r border-gray-50">
                          <div className="text-gray-900 font-bold mb-1">{s.name}</div>
                          <button className="text-[#2563eb] text-[12px] hover:underline font-medium">View Scholarship</button>
                        </td>
                        <td className="p-5 align-top border-r border-gray-50 text-gray-600">{s.level}</td>
                        <td className="p-5 align-top border-r border-gray-50 text-gray-600">{s.stream}</td>
                        <td className="p-5 align-top border-r border-gray-50 font-bold text-emerald-600">{s.coverage}</td>
                        <td className="p-5 align-top border-r border-gray-50 text-gray-600">{s.eligibility}</td>
                        <td className="p-5 align-top border-r border-gray-50 font-medium text-gray-900">{s.seats}</td>
                        <td className="p-5 align-top">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#111827] mb-8">Application Flow</h2>
            ...
            <section className="bg-[#fffbeb] border border-[#fef3c7] rounded-[32px] p-8 sm:p-10 shadow-sm mt-12">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center relative flex-shrink-0 border border-amber-100">
                  <div className="absolute top-2 left-2 text-amber-400">
                    ...
                    <span className="absolute inset-0 flex items-center justify-center text-[10px] font-black text-white -mt-1">Q</span>
                  </div>
                  <div className="absolute bottom-2 right-2 text-rose-300">
                    <MessageCircle className="w-6 h-6 fill-current" />
                    <span className="absolute inset-0 flex items-center justify-center text-[10px] font-black text-white -mt-1">A</span>
                  </div>
                </div>
                <div>
                  <span className="text-[13px] text-amber-700 font-bold tracking-widest uppercase">Community</span>
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-[#111827] mt-1">Student Forum</h2>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-amber-50">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-lg font-bold text-gray-900">Have any questions for our experts?</h3>
                </div>
              ...
              <div className="mt-10 space-y-6">
                {[
                  ...
                  <div key={idx} className="bg-white rounded-2xl p-6 sm:p-8 border border-white shadow-sm hover:shadow-md transition-shadow">
                    <h3 className="text-lg font-bold text-gray-900 mb-2 leading-tight uppercase tracking-tight">{post.q}</h3>
                    ...
                    <div className="text-[15px] text-gray-600 leading-relaxed mb-6">
                      {post.ans}
                      <button className="text-[#2563eb] hover:underline font-bold ml-1">...Read more</button>
                    </div>
                    ...
                    <div className="border-t border-gray-50 pt-5 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-[14px] font-bold text-gray-900">{post.author}</div>
                          <div className="text-[12px] text-gray-500 font-medium">{post.role}</div>
                        </div>
                      </div>
                      <div className="flex gap-2">
                         <button className="p-2 hover:bg-gray-50 rounded-full transition-colors text-gray-400"><Share2 className="w-4 h-4" /></button>
                         <button className="p-2 hover:bg-gray-50 rounded-full transition-colors text-gray-400"><Bookmark className="w-4 h-4" /></button>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <aside className="space-y-10 mt-8 lg:mt-0 sticky top-24">
            ...
            <div className="bg-white rounded-3xl shadow-xl shadow-gray-100 border border-gray-50 p-8 space-y-6">
              <h3 className="text-xl font-bold text-gray-900 leading-tight">Are You Interested in this College?</h3>
              <div className="space-y-4">
            ...
            <div className="bg-white rounded-[32px] shadow-sm border border-gray-100 p-8">
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={idx} className="group cursor-pointer flex gap-4 items-start">
                    <div className="relative shrink-0 overflow-hidden rounded-2xl w-20 h-20 shadow-sm">
                      <img src={update.img} alt={update.tag} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <span className={`inline-block ${update.tagColor} text-[10px] font-black px-2 py-0.5 rounded-md uppercase mb-2 tracking-widest`}>
                        {update.tag}
                      </span>
            ...
            <div className="bg-white rounded-[32px] shadow-sm border border-gray-100 p-8">
              ...
              <div className="space-y-6">
                {[
                  { month: "May", day: "15", title: "Science & Tech Exhibition 2026", loc: "Academy Hall", color: "bg-blue-50 text-blue-600" },
                  { month: "Jun", day: "02", title: "Orientation for New Batch", loc: "Main Auditorium", color: "bg-rose-50 text-rose-600" }
                ].map((ev, idx) => (
                  <div key={idx} className="group cursor-pointer flex gap-5 items-center">
                    <div className={`flex flex-col items-center justify-center rounded-2xl w-16 h-16 shrink-0 ${ev.color} shadow-sm border border-white`}>
                      <span className="text-[11px] font-black uppercase leading-none mb-1 tracking-widest">{ev.month}</span>
            ...
            <div className="bg-[#1e1b4b] rounded-[32px] shadow-xl text-white p-8">
              <div className="mb-8">
                <span className="text-blue-300 text-xs font-bold tracking-widest uppercase">Contact</span>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-100/70 leading-relaxed font-medium">
                      KIST College Campus, Kamalpokhari<br/>
                      Kathmandu, Nepal
                    </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-100/70 font-medium">01-4434984, 4434985</p>
                    <p className="text-xs text-blue-100/40 mt-1 uppercase tracking-widest">General Enquiries</p>
                  </div>
                </div>

                <div className="flex gap-4 mt-4">
                   <div className="p-3 bg-white/0 rounded-xl h-fit invisible"><Phone className="w-5 h-5" /></div>
                   <div>
                    <p className="text-sm text-blue-100/70 font-medium">+977-9841234567</p>
                    <p className="text-xs text-blue-100/40 mt-1 uppercase tracking-widest">Admission Helpdesk</p>
                   </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@kist.edu.np" className="text-sm text-blue-100/70 hover:text-white transition-colors">info@kist.edu.np</a>
                  </div>
                </div>
              </div>
              ...
              <button className="mt-10 w-full bg-white text-[#1e1b4b] font-black py-4 rounded-2xl hover:bg-blue-50 transition-all flex items-center justify-center gap-2 group">
                Visit Official Website <ExternalLink className="w-4 h-4 group-hover:scale-110" />
              </button>
            </div>
      ...
      {showNotificationModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center -mb-20">
          ...
          <div className="relative bg-white rounded-3xl w-full max-w-sm mx-4 p-8 shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <div className="space-y-5">
              <div className="relative">
                <select className="w-full px-4 py-4 bg-gray-50 border border-gray-100 rounded-2xl text-[15px] appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500/20 font-medium">
                  <option value="" disabled selected hidden>Choose your field of interest</option>
            ...
            <p className="text-[11px] text-gray-400 text-center mt-4">We value your privacy. Unsubscribe at any time.</p>
          </div>
        </div>
      )}
    </div>
