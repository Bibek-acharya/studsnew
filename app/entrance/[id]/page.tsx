    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-350 pt-12 pb-8">
        <nav className="flex items-center text-sm text-gray-500 mb-6 gap-2">
          <span className="hover:text-gray-900 transition-colors cursor-pointer" onClick={() => router.push("/")}>Home</span>
          <ChevronRight className="w-4 h-4 text-gray-400" />
          <span className="hover:text-gray-900 transition-colors cursor-pointer" onClick={() => router.push("/entrance")}>Entrance</span>
          <ChevronRight className="w-4 h-4 text-gray-400" />
            ...
            <div className="space-y-10">
              ...
              <div className="border border-gray-200 rounded-md overflow-hidden">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-[#eff4fc]">
                    <tr>
                      <th className="py-3 px-4 text-left text-sm font-bold text-gray-900 w-1/3">Detail</th>
                      <th className="py-3 px-4 text-left text-sm font-bold text-gray-900">Information</th>
                    </tr>
                  </thead>
              ...
              <div className="border border-gray-100 rounded-md p-5 sm:p-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900">Exam Dates & Schedule</h2>
                    <p className="text-sm text-gray-500 mt-1">Complete schedule for {exam.title}</p>
                  </div>
                ...
                <div className="overflow-x-auto rounded-md border border-gray-200">
                  <table className="w-full text-left border-collapse min-w-[600px]">
                    <thead className="bg-[#eff4fc]">
                      <tr>
                        <th className="p-4 font-bold text-gray-900 w-1/3 border-r border-gray-200">Dates</th>
                        <th className="p-4 font-bold text-gray-900 border-r border-gray-200">Upcoming Exam Dates</th>
                        <th className="p-4 font-bold text-gray-900 w-[15%]">Status</th>
                      </tr>
                    </thead>
                    <tbody className="text-[15px]">
                      {exam.upcomingDates.map((date, idx) => (
                        <tr key={idx} className="border-b border-gray-200 hover:bg-gray-50">
                          <td className="p-4 align-top border-r border-gray-200 text-gray-700">{date.dateEn}</td>
                          <td className="p-4 align-top border-r border-gray-200">
                            <span className="font-semibold text-gray-900">{date.event}</span>
                          </td>
                          <td className="p-4 align-top">
                            {date.status && (
                              <span className="inline-block bg-green-700 text-white text-[10px] font-bold px-2 py-0.5 rounded uppercase">{date.status}</span>
                            )}
                          </td>
                        </tr>
                      ))}
          ...
          {activeTab === "syllabus" && (
            <div>
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  {exam.title} is a single-paper examination consisting of Multiple Choice Questions (MCQs). The syllabus is based on the prescribed curriculum.
                </p>
              </div>
                  ...
                  <div key={idx} className="flex items-center justify-between p-4 border border-gray-200 rounded-md bg-white">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">PDF &bull; {set.size} &bull; {set.description}</p>
                      </div>
                    </div>
                  ...
                  <div key={idx} className="border border-gray-200 rounded-md p-6 bg-white">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[#0000ff] font-medium">{person.role}</p>
                      </div>
                    </div>
                    <div className="space-y-2 text-sm mb-4">
                      ...
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        <a href={`mailto:${person.email}`} className="hover:text-[#0000ff] transition">{person.email}</a>
                      </div>
                    </div>
                    <a
              ...
              <div className="space-y-3">
                {exam.faqs.map((faq, idx) => (
                  <div key={idx} className="bg-white rounded-md overflow-hidden border border-gray-100">
                    ...
                    >
                      <span className="font-semibold text-gray-900 text-[15px] pr-4">Q: {faq.question}</span>
                      <ChevronDown
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-[13px] text-white/90 leading-relaxed mb-3">
                  Apply now or download the notice for more information about the exam, syllabus, and admission process.
                </p>
              </div>
          ...
          <div className="bg-white border border-gray-100 rounded-md p-5">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-[13px]">
                ...
                <div>
                  <span className="block text-gray-900 font-bold text-[13px]">Conducting Body</span>
                ...
                <div className="bg-gray-100 h-[160px] flex items-center justify-center relative">
                  <div className="absolute inset-0 bg-gray-200 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-xs font-medium text-gray-700 mb-1">{exam.location}</p>
          ...
          <div className="bg-white border border-gray-100 rounded-md p-5">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="block text-gray-900 font-bold text-[13px]">Exam Level</span>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="block text-gray-900 font-bold text-[13px]">Duration</span>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="block text-gray-900 font-bold text-[13px]">Question Type</span>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="block text-gray-900 font-bold text-[13px]">Application Fee</span>
          ...
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-md px-4 pt-5 pb-4 text-left overflow-hidden transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6 relative">
              ...
              <div className="px-2 pt-2">
                <h3 className="text-[17px] font-bold text-gray-900 leading-snug mb-5" id="modal-title">
