  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
      ...
      <div
        ...
        style={{ backgroundColor: community.bg_color || "#2563eb" }}
      />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative pb-6 border-b border-gray-200">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end -mt-16 sm:-mt-12 mb-4 gap-4">
            <div
              className={`w-28 h-28 sm:w-32 sm:h-32 rounded-2xl border-4 border-white flex items-center justify-center shadow-sm shrink-0 ${
                community.bg_color || "bg-blue-600"
              }`}
            >
              {community.icon ? (
                <DynamicIcon name={community.icon} size={56} />
              ) : (
            ...
            <div className="flex items-center gap-3 mt-4 sm:mt-0 w-full sm:w-auto justify-between sm:justify-end">
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`font-semibold px-5 py-2.5 rounded-full flex items-center gap-2 transition-colors text-sm ${
                    isJoined
                ...
                <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium px-4 py-2.5 rounded-full flex items-center gap-2 transition-colors text-sm">
                ...
                <div key={post.id} className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-xs font-medium text-gray-500 pt-2 border-t border-gray-100">
                    <button
                      ...
                      className={`flex items-center gap-1 px-3 py-1.5 rounded-full hover:bg-gray-100 transition-colors ${post.is_liked ? "text-blue-600" : ""}`}
                    >
                      <ArrowUp size={14} />
                      {post.upvotes || 0}
                    </button>
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full hover:bg-gray-100 transition-colors ${post.is_disliked ? "text-red-600" : ""}`}
                    >
                      <ArrowDown size={14} />
                    </button>
                    <button className="flex items-center gap-1 px-3 py-1.5 rounded-full hover:bg-gray-100 transition-colors">
